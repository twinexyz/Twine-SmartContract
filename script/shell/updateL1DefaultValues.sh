...
FILES=(
    ...
    "script/shell/setups/L1Setups/L1MessageQueueSteup/setChainIdMQ.sh"
    "script/shell/setups/L1Setups/L1MessageQueueSteup/setMessageProxyMQ.sh"
    "script/shell/setups/L1Setups/L1MessageQueueSteup/setRoleManagerMQ.sh"
    "script/shell/setups/L1Setups/L1MessageQueueSteup/setTwineMessengerMQ.sh"

    "script/shell/setups/L1Setups/L1MessengerSetup/setCounterpartMessengerMS.sh"
    "script/shell/setups/L1Setups/L1MessengerSetup/setMessageQueueMS.sh"
    ...
    "script/shell/setups/L1Setups/TwineChainSetup/setMessageQueueTC.sh"
