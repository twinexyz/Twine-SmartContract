...
interface IL1XERC20Gateway {
    ...
    function getL2XERC20Address(address _l1Token) external view returns (address);
    ...
    event RefundXERC20(address indexed token, address indexed recipient, uint256 amount);
