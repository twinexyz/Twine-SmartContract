...
abstract contract CentralizedERC20Gateway is ICentralizedERC20Gateway, TwineL1GatewayBase {
   ...
   /// @inheritdoc ICentralizedERC20Gateway
    ...
    function _transferERC20In(
        ...
        if (gatewayRouter == sender) {
            ...
            amount = ICentralizedGatewayRouter(sender).requestERC20(from, token, amount);
        } else {
