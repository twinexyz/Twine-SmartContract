...
//         IL2TwineMessenger.ContractCall[] memory emptyForcedTxns = new IL2TwineMessenger.ContractCall[](0);
...
//         vm.startPrank(initialOwner);
//         messenger.setTokenGateWay(0, l2Token, address(gateway));
//         IL2TwineMessenger.ContractCall[]
//             memory forcedTxns = new IL2TwineMessenger.ContractCall[](1);
//         bytes
...
//         forcedTxns[0] = IL2TwineMessenger.ContractCall({
