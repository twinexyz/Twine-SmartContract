...
contract TwineChainTest is Test {
    ...
    function setUp() public {
        ...
        executionVKey = keccak256("executionVKey");
        inclusionVKey = keccak256("inclusionVKey");
    ...
    function testSetProgramVKey() public {
        vm.prank(admin);
        twineChain.setProgramVKey(executionVKey, inclusionVKey, withdrawalVKey);
        assertEq(twineChain.executionVKey(), executionVKey);
        assertEq(twineChain.inclusionVKey(), inclusionVKey);
    ...
    function testTheWholeFlow() public {
        ...
        bytes
            memory transactionInfo = hex"";
